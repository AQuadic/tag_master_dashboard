    ...
    return (
        <section>
            <div className="flex flex-wrap items-center gap-5">
                {productsFilter.map((products) => (
                    <div
                        ...
                        className={`py-3 px-6 border-[0.88px] border-[#000000] rounded-[7px] flex items-center justify-center cursor-pointer transition-colors ${activeProducts === products
                            ? "bg-[#002847] text-white border-none"
                            : "bg-transparent text-[#000000]"
                            }`}
                    >
                        <p className="text-[21.02px] font-medium">{products}</p>
                    </div>
                ))}
            </div>
            <div className="mt-[26px] flex flex-wrap items-center gap-[42px]">
                {cardData.map((product, index) => (
                    <div key={index} className="w-[275px]">
                        ...
                        />
                        <div className="h-[58px] border-b border-r border-l border-[#000000] rounded-b-[12px] px-3">
            ...
            <div className="flex items-center justify-center mt-32">
                <button className="w-[255px] h-[59px] bg-[#002847] rounded-[12px] text-[#FFFFFF] text-2xl font-medium">Buy a product</button>
            </div>
        </section>
    )
}
